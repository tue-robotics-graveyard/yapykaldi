...
class GmmOnlineModelWrapper
{
 ...
 public:
  GmmOnlineModelWrapper(BaseFloat beam, int32 max_active, int32 min_active,
                        BaseFloat lattice_beam, std::string &word_syms_filename,
                        std::string &fst_in_str, std::string &config,
